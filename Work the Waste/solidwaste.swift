                  ...
                  HStack {
                    ...
                    ZStack { Color(red: 0.91764705882, green: 0.90588235294, blue: 0.69411764705)
                      VStack {
                        ...
                        Text("These include Contaminated ponds, pits, or reservoirs Septic/Grey Water, medical waste, human and animal dung, household wastewater,cooking oil,fats, and grease.")
                          .font(.headline)
                          .foregroundColor(Color("textcolor"))
                          .padding(/*@START_MENU_TOKEN@*/.all, 10.0/*@END_MENU_TOKEN@*/)
                      }
